...
- Published the macOS ARM64 desktop build as an explicitly ad-hoc-signed, non-notarized community artifact; the account-free PWA remains the no-Gatekeeper option.
