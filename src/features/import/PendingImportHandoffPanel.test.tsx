...
describe('PendingImportHandoffPanel', () => {
  ...
  it('states the local-only boundary and exports only eligible candidate-review runs', async () => {
    render(<PendingImportHandoffPanel householdId="family" accounts={accounts} members={members} pendingRuns={[candidateRun, receiptRun, futureReceiptRun, investmentRun, sourceOnlyRun]} onApplied={vi.fn()} />)
