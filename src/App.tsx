...
function App() {
  ...
  const pageContent = {
    ...
    settings: <><SettingsPage householdId={activeHouseholdId} accounts={accounts} members={householdMembers} onAccountsChanged={async () => { if (activeHouseholdId) setAccounts(await platformClient.listAccounts(activeHouseholdId)) }} /><LocalSyncFoundationPanel householdId={activeHouseholdId} /><LocalChangePackagePanel householdId={activeHouseholdId} />{platformClient.runtime === 'tauri' && <DelimitedParserProfilesPanel householdId={activeHouseholdId} />}</>,
  }[page]
