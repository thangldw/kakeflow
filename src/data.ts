...
export const spendingTrend = [
  { month: '2月', income: 1000, expense: 642 },
  { month: '3月', income: 1000, expense: 671 },
  { month: '4月', income: 1000, expense: 708 },
  { month: '5月', income: 1000, expense: 688 },
  { month: '6月', income: 3000, expense: 824 },
  { month: '7月', income: 1000, expense: 637.08 },
]

export const categoryData = [
  { name: '税金・社会保険', amount: 240000, pct: 38, color: '#a64f43' },
  { name: '食費', amount: 128000, pct: 20, color: '#c06d4f' },
  { name: '教育・子ども', amount: 92000, pct: 14, color: '#a56c22' },
  { name: '住居・光熱', amount: 88600, pct: 14, color: '#6f7d57' },
  { name: '交通', amount: 36000, pct: 6, color: '#e4aa45' },
  { name: 'その他', amount: 52480, pct: 8, color: '#7f9ba5' },
]
...
export const transactions: Transaction[] = [
  ...
  { id: '3', date: '7月18日', merchant: '成城石井', detail: 'PayPay QR決済・食料品', category: '食費', account: 'PayPay残高', amount: -6480, status: 'confirmed', icon: 'food' },
  { id: '4', date: '7月16日', merchant: 'LOHACO 教材', detail: '子どもの教材', category: '教育・子ども', account: 'PayPayカード', amount: -7200, status: 'confirmed', icon: 'subscription', accountingEffect: 'ACCRUAL_ONLY' },
  { id: '5', date: '7月12日', merchant: '東京電力', detail: '7月分電気料金', category: '住居・光熱', account: '三井住友銀行・家計', amount: -26400, status: 'confirmed', icon: 'home' },
  { id: '6', date: '7月27日', merchant: '住宅ローン返済', detail: '元金120,000円・利息30,000円', category: '資金移動', account: '三井住友銀行・家計', amount: -150000, status: 'confirmed', icon: 'home', accountingEffect: 'CASH_ONLY' },
  { id: '7', date: '7月27日', merchant: '楽天カード支払い', detail: '6月請求のSMBC口座引落', category: '資金移動', account: '三井住友銀行・家計', amount: -204987, status: 'confirmed', icon: 'subscription', accountingEffect: 'CASH_ONLY' },
  { id: '8', date: '7月27日', merchant: 'PayPayカード支払い', detail: '6月請求のSMBC口座引落', category: '資金移動', account: '三井住友銀行・家計', amount: -20170, status: 'confirmed', icon: 'subscription', accountingEffect: 'CASH_ONLY' },
]
