...
export const spendingTrend = [
  ...
  { month: '7月', income: 652, expense: 386 },
]
...
export const transactions: Transaction[] = [
  ...
  { id: '3', date: '7月10日', merchant: 'JR EAST', detail: 'モバイルSuica', category: '交通', account: 'Rakuten Card', amount: -5000, status: 'confirmed', icon: 'transport' },
  { id: '4', date: '7月10日', merchant: '給与振込', detail: '株式会社 Kake', category: '収入', account: 'MUFG', amount: 426800, status: 'confirmed', icon: 'income' },
  { id: '5', date: '7月9日', merchant: 'Netflix.com', detail: '月額利用料', category: '娯楽', account: 'Amazon Mastercard', amount: -1490, status: 'review', icon: 'subscription' },
]
