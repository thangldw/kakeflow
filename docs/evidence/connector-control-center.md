...
| opaque updater-signing environment injection plus `npm run desktop:build:mac:ci` | Passed for the current build-input identity; arm64 app, DMG, updater archive, detached signature, and success identity created. |
...
The earlier artifact set was valid only for its recorded source identity and was rejected after hardening with `Native build input identity mismatch`. The controller then performed one clean arm64 rebuild with the previously verified opaque signing injection and reran package, DMG, privacy, architecture, and codesign checks. The injection mechanism, location, and key material remain outside tracked documentation.
...
- Updater archive: SHA-256 `e1c53cdf3ba14e4cb5156fa7005cdb33bedcb97ae913190224336faf33df4e8f`.
- Detached updater signature: SHA-256 `98864d860be5469abef2b39f3887e5b713d4e58086fd42121f075deee7e8d3c8`.
- DMG: SHA-256 `b3acb78e2d57cd59a2305752deb4945221a71bf6a561919bcc76c5b1b1e5436f`.
- `kakeflow-build-identity.json`: SHA-256 `c3b0e62d76b86b320af352c49a1bd311545d26b42da2c7d0880b2669a1aeb41d`; build-input identity `3cc8aaa969bfc1c2c568cab5a082213ca3aec974c724f7ec8a8ea0dbc0e9ba3b`.
...
The fresh PWA build, Poppler manifest/checklist/PNGs, Playwright result, connector batch test sources, native app/updater/DMG, and this evidence were inspected for credential values, authorization-code values, cursor values, personal absolute paths, provider folder/label values, personal emails, real financial payloads, premium branding, and unsupported direct-institution or installer claims.
